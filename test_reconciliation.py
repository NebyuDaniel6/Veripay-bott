...
# PRD:M2.x Reconciliation - Skipping until Milestone 2 implementation begins
pytest.skip("Skipping reconciliation tests until M2 starts", allow_module_level=True)
